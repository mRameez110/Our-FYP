...
function EditProfile() {
  ...
  const submitProfile = async () => {
    ...
    const result = await axios.post("/api/doctor/update", {
    ...
    if (result.status === 200) {
      ...
      setTimeout(() => {
        ...
        navigate("/doctor/dashboard/view-profile");
      }, 3000);
    }
    setLoading(false);
  };
  ...
  const handleFileChange = (e) => {
    ...
    reader.onloadend = () => {
      setDoctor({ ...doctor, profile: reader.result });
    };
  };
  ...
  const saveInfo = (e) => {
    e.preventDefault();
    setLoading(true);
    localStorage.setItem("info", JSON.stringify(doctor));
        ...
        <div className="bg-light p-4 rounded-3">
          <div className="container">
            ...
            <p className="lead mb-0 pb-0">
              Complete the profile and become eligible for tutor position
            </p>
          </div>
        </div>
                    ...
                    <div className="row">
                      <div className="col-md-6">
                        <div className="form-group">
                          <label for="Fullname" className="form-label mt-4">
                            Full Name
                          </label>
                          <input
                            type="text"
                    ...
                    <div className="row">
                      ...
                      <div className="col-md-6">
                        <div className="row">
                          <div className="col-6">
                            <div className="form-group">
                              <label for="Age" className="form-label mt-4">
                                Age
                              </label>
                              <input
                                type="number"
                          ...
                          <div className="col-md-6">
                            <div class="form-group">
                              <label for="Gender" class="form-label mt-4">
                                Gender
                              </label>
                              <select
                    ...
                    <div className="d-flex my-4 align-items-center">
                      <div className="d-flex align-items-center">
                        <div className="form-check">
                          ...
                          >
                            I confirm that I've no criminal background or
                            pending case.
                          </label>
                        </div>
                      </div>
                ...
                <div class="accordion-body">
                  <div className="container px-4">
                    <div className="row">
                      ...
                      <div className="col-md-6">
                        <div className="form-group">
                          <label for="Interest" className="form-label mt-4">
                            Area of Interest
                          </label>
                          <input
                            type="text"
                  ...
                  <div className="container px-4">
                    <div className="row">
                      <div className="col-md-4">
                        <div className="form-group">
                          <label for="hours" className="form-label mt-4">
                            Available hours in day
                          </label>
                          <input
                            type="text"
                            className="form-control"
                            id="hours"
                            placeholder="No. of available hours"
                            name="hour"
                            value={availability.hour}
                            onChange={handleChangeInputAvailability}
                          />
                        </div>
                      </div>
                      ...
                      <div className="col-md-8">
                        <div class="form-group">
                          <label
                            ...
                            className="form-label mt-4"
                          >
                            Availability start and end hours
                          </label>
                          <div class="row">
                            <div class="col">
                              <input
                    ...
                    <div className="row">
                      <div class="form-group">
                        <label for="days" className="form-label mt-4">
                          Days of the week
                        </label>
                        <div class="d-flex">
                          <div class="form-check me-3">
                            <input
                              ...
                              checked={
                                availability &&
                                availability.days &&
                                availability.days.includes("monday")
                              }
                            />
                          ...
                          <div class="form-check me-3">
                            <input
                              ...
                              checked={
                                availability &&
                                availability.days &&
                                availability.days.includes("tuesday")
                              }
                            />
                          ...
                          <div class="form-check me-3">
                            <input
                              ...
                              checked={
                                availability &&
                                availability.days &&
                                availability.days.includes("wednesday")
                              }
                            />
                          ...
                          <div class="form-check me-3">
                            <input
                              ...
                              checked={
                                availability &&
                                availability.days &&
                                availability.days.includes("thursday")
                              }
                            />
                          ...
                          <div class="form-check me-3">
                            <input
                              ...
                              checked={
                                availability &&
                                availability.days &&
                                availability.days.includes("friday")
                              }
                            />
                          ...
                          <div class="form-check me-3">
                            <input
                              ...
                              checked={
                                availability &&
                                availability.days &&
                                availability.days.includes("saturday")
                              }
                            />
                    ...
                    <div className="row">
                      <div class="form-group">
                        <label for="timeslots" className="form-label mt-4">
                          Time slots
                        </label>
                        <div class="d-flex">
                          <div class="form-check me-3">
                            <input
                              ...
                              checked={
                                ...
                                availability.timeslot.includes("morning")
                              }
                            />
                          ...
                          <div class="form-check me-3">
                            <input
                              ...
                              checked={
                                availability &&
                                availability.timeslot &&
                                availability.timeslot.includes("afternoon")
                              }
                            />
                          ...
                          <div class="form-check me-3">
                            <input
                              ...
                              checked={
                                availability &&
                                availability.timeslot &&
                                availability.timeslot.includes("evening")
                              }
                            />
                    ...
                    {/* {map && (
                      <div className="row">
                        <div class="my-4">
                          <MyMapComponent
                            lat={availability.location[0]}
                            lng={availability.location[1]}
                          />
                        </div>
                      </div>
                    )} */}
