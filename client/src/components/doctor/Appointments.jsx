...
function Appointments() {
  ...
  const getAppointments = async () => {
    setLoading(true);
    const { data } = await axios.post("/api/doctor/appointment/get", {
      doctor: JSON.parse(localStorage.getItem("doctor")).username,
    });
  ...
  function cancelAppointment(appointment) {
    setLoading(true);
    const { data } = axios.post("/api/doctor/appointment/cancel", {
      appointment,
    });
    setUpdate(!update);
    setLoading(false);
  ...
  const acceptAppointment = async (appointment) => {
    setLoading(true);
    const { data } = await axios.post("/api/doctor/appointment/accept", {
      appointment,
      link,
    });
    setUpdate(!update);
  ...
  const modifyAppointment = async (appointment) => {
    setLoading(true);
    const { data } = await axios.post("/api/doctor/appointment/modify", {
                    ...
                    <div className="card-body">
                      <div className="d-flex justify-content-between align-items-center">
                        <div className="col-5 d-flex m-3 align-items-center">
                          <img
                            src={appointment.patient.profile}
                            alt="profile"
                      ...
                      <div className="d-flex flex-column">
                        ...
                        <div className="row justify-content-center mt-4">
                          <button
                            id={appointment._id}
                            className="col-3 mx-2 btn btn-warning"
                            data-toggle="modal"
                          ...
                          <button
                            className="col-3 mx-2 btn btn-success"
                            data-toggle="modal"
                          ...
                          <button
                            className="col-3 mx-2 btn btn-danger"
                            onClick={() => {
