...
function User({ name, profile, city, rating, expertise, username }) {
  return (
    <Link
      ...
      to={`/student/dashboard/profile/${username}`}
    >
      <div className="row">
...
function Finder() {
  const [users, setTeachers] = useState([]);
              ...
              <div className="card-body">
                ...
                {!loading && position == null && (
                  <div className="my-3">
                    ...
                    <UsersList users={filteredTeachers} />
                  </div>
                )}
                {!loading && position && (
                  <div>
                    {
                      <MyMapComponent
                        ...
                        itemLocations={filteredTeachers.map((user) => {
                          return {
                            name: user.name,
                            profile: user.profile,
                            username: user.username,
