...
function Services() {
  return (
    <section id="services" className="bg-light py-5 py-xl-6">
        ...
        <div className="row justify-content-md-center">
          <div className="col-12 col-md-10 col-lg-8 col-xl-7 col-xxl-6 text-center">
            ...
            <p className="text-dark mb-4 mb-md-5">
              At Doctor Hub, we understand that every citizen is unique, and and
              have right to maintain basic health. We are Providing online
              medical services with providing you best doctor.
            </p>
        ...
        <div className="row gy-5 gy-md-6 gx-xl-6">
          <div className="col-12 col-sm-6 col-lg-4">
            <div className="text-center">
              ...
              <h5 className="m-2">Doctor Searching</h5>
          ...
          <div className="col-12 col-sm-6 col-lg-4">
            <div className="text-center">
              ...
              <h5 className="m-2">Relaible Doctors</h5>
              <p className="m-0 text-dark">
                Vestibulum bibendum, lorem a blandit lacinia, nisi velit posuere
                nisl, vel placerat magna mauris mollis maximus est.
              </p>
          ...
          <div className="col-12 col-sm-6 col-lg-4">
            <div className="text-center">
              ...
              <h5 className="m-2">Appointment Schedule</h5>
              <p className="m-0 text-dark">
                Vestibulum bibendum, lorem a blandit lacinia, nisi velit posuere
                nisl, vel placerat magna mauris mollis maximus est.
              </p>
          ...
          <div className="col-12 col-sm-6 col-lg-4">
            <div className="text-center">
              ...
              <h5 className="m-2">Online Payment</h5>
              <p className="m-0 text-dark">
                Vestibulum bibendum, lorem a blandit lacinia, nisi velit posuere
                nisl, vel placerat magna mauris mollis maximus est.
              </p>
