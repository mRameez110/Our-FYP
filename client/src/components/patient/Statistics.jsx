...
function Statistics({ patient }) {
  ...
  const profileFields = [
    ...
    { field: "profile", weight: 5 },
    { field: "contactno", weight: 10 },
    { field: "dob", weight: 5 },
    ...
    <>
      {
        <div className="my-5">
          ...
          <section className="mb-5">
            <div className="d-flex align-items-center justify-content-between bg-light rounded-4">
              <div className="col-6 p-4">
                <h3 className="">Welcome {patient.name}</h3>
          ...
          {/* Section: Of Profile Completion and is verified */}
          <section className="mb-5">
                ...
                <div className="bg-light p-3 rounded shadow-lg">
                  ...
                  <div className="d-flex justify-content-around align-items-center">
                    ...
                    <div className="col-9 d-flex flex-column">
                      <h4 className="mb-2 lead text-center">{patient.name}</h4>
