            ...
            profile.dob ? (
              <div className="d-flex align-items-center bg-light p-4 mb-3 rounded-3">
                <div className="col-2 mb-3">
                  <img
                    src="https://img.icons8.com/color/256/graduation-cap.png"
                    alt="graduation"
                    className="img-fluid"
                    width={"170px"}
                  />
                ...
                <div className="col-10">
                  <div className="d-flex align-items-center">
                    <div className="mx-4">
                      ...
                      <p className="text-dark">
                        We will use this information to improve your experience
                        and to provide you with the best service and
                        recommendation.
                      </p>
                      <Link
              ...
              <div className="d-flex justify-content-between align-items-center bg-light p-4 mb-4 rounded-3">
                <div className="col-2 mb-3">
                  <img
                    src="https://img.icons8.com/color/256/warning-shield.png"
                    alt="graduation"
                    className="img-fluid"
                    width={"170px"}
                  />
                ...
                <div className="col-10">
                  <div className="d-flex align-items-center">
                    <div className="mx-4">
                      ...
                      <p className="text-dark">
                        It is recommended to complete your profile to get better
                        experience and to get better recommendations.
                      </p>
                      <Link
                        to="/patient/dashboard/edit-profile"
